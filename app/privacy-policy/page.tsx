          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <div className="p-8 rounded-2xl backdrop-blur-xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Aspiring Engineers is an online educational platform providing
                digital test preparation material and academic guidance. We do
                not sell physical products.
              </p>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Welcome to Aspiring Engineers (&quot;we,&quot; &quot;our,&quot;
            ...
            <div className="p-8 rounded-2xl backdrop-blur-xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                All purchases made on Aspiring Engineers are for digital
                educational services including mock tests, practice questions,
                and counselling guidance.
              </p>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Once a test series or digital product is activated or accessed,
                it is considered consumed and is generally non-refundable.
                Refunds may only be provided in the following cases:
              </p>
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 mb-4 space-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Refund requests must be raised within 48 hours of transaction by
                contacting aspiringengineersofficial@gmail.com.
              </p>
              <p className="text-gray-600 dark:text-gray-400">
                Approved refunds will be processed within 5–7 working days to
            ...
            <div className="p-8 rounded-2xl backdrop-blur-xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 space-y-2">
                <li>
                  ...
                  (e.g., payment processing, email delivery)
                </li>
                <li>
            ...
            <div className="p-8 rounded-2xl backdrop-blur-xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Our services are intended for students preparing for competitive
                examinations. If you are under 18 years of age, please use our
                services only with the involvement of a parent or guardian. We
                do not knowingly collect personal information from children
                under 13 without parental consent.
              </p>
              <p className="text-gray-600 dark:text-gray-400">
                Payments can only be made by a parent or guardian if the user is
